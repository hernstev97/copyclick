...
// selectors
const pastearea = document.querySelector(
    'textarea.pastearea'
) as HTMLTextAreaElement;
const copybox = document.querySelector('div.pastearea') as HTMLDivElement;
const clearPasteAreaButton = document.querySelector(
    '#clear-pastearea'
) as HTMLButtonElement;
const copyTextButton = document.querySelector(
    '#copy-text'
) as HTMLButtonElement;
const copyFeedbackBlip = document.querySelector(
    '.copy-feedback'
) as HTMLParagraphElement;
const editModeCheckbox = document.querySelector(
    '#editmode'
) as HTMLInputElement;
...
// functions
function textBoxResizeToFitContent(
    textarea: HTMLTextAreaElement,
    copybox: HTMLDivElement
) {
    console.log('ping');
